				...
				<div className="page--container">
					<div className="page-contact-main-header page-part">
						<div className="page-part-container">
							...
							<h2>
								GEC Group Construction Management is built to modernize, expand
								and deliver the most amazing structures
							</h2>
							<p>
						...
						<div className="page-part-container">
							...
							<p>
								...
								Group has evolved into the most successful real estate business,
								made up of nearly 300 passionate property professionals and 201
